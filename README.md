...
This is a web page where you can add and remove books, these are going to be stored in the local storage. 
...
- [Live Demo Link](https://shm04.github.io/awesome-books/)
...
```
  cd my-folder
  git clone git@github.com:myaccount/awesome-books.git 
```
